...
int main()
{
	...
	cout << "Here are the steps you took: " <<endl;
	for(int i = 0; i < dirTrack.size(); i++)
	{
		cout << dirTrack[i];
		cout << ", ";
        }
	cout << "To get back where you started, you can do this: " <<endl;
	reverse(dirTrack.begin(),dirTrack.end());
	for(int i = 0; i < dirTrack.size(); i++)
	{
		cout << dirTrack[i];
		cout << ", ";
